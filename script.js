...
// --- 2. MODAL LOGIC (Existing functionality is fine, keeping original) ---
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function openRegistrationModal(gameName) {
        ...
        `;
        optionsContainer.insertAdjacentHTML('afterend', registerButtonButtonHTML);
